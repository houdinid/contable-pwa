...
export default function CreateSoftwareLicensePage() {
    const router = useRouter();
    const { addSoftwareLicense, contacts } = useData();
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            console.error(error);
            alert("Error al guardar la licencia de software");
        } finally {
    ...
    return (
        <div className="max-w-4xl mx-auto pb-10">
            ...
            <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-foreground">Nueva Licencia de Software</h1>
                    <p className="text-gray-500 dark:text-gray-400">Registra licencias de Windows, Office 365, AutoCAD, etc.</p>
                </div>
            </div>
